...
async function fetchAPIData(endpoint){
  const API_KEY ='2446ce71ba8b1e74f134293b4fa94779';
...
async function displayMovieDetails(){
  ...
  document.title = `Flixx | ${movie.title}`;
  const div = document.createElement('div');
  div.innerHTML = `<div class="details-top">
      ...
      <div class="details-bottom">
        ...
        <ul>
          ...
          <li><span class="text-secondary">Runtime:</span> ${addCommasToNumber(movie.runtime)}</li>
...
async function displayTVDetails(){
  ...
  document.title = `Flixx | ${show.name}`;
  const div = document.createElement('div');
  div.innerHTML = `<div class="details-top">
        <div>
          ${
      ...
      <div class="details-bottom">
        ...
        <ul>
          ...
          <li>
            <span class="text-secondary">Last Episode To Air:</span> S${show.last_episode_to_air.season_number} E${show.last_episode_to_air.episode_number} : ${show.last_episode_to_air.name}
          </li>
...
async function displaySwiperShows(){
  const { results } = await fetchAPIData('tv/on_the_air');
  results.forEach((show)=>{
      const div = document.createElement('div');
      div.classList.add('swiper-slide');
      div.innerHTML = `<a href="tv-details.html?id=${show.id}">
            <img src="https://images.tmdb.org/t/p/w500${show.poster_path}" alt="${show.name}" />
          </a>
          <h4 class="swiper-rating">
